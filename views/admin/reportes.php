...
if (isset($_GET['exportar'])) {
    ...
    if ($tipo === 'materiales') {
        ...
        exportarCSV('reporte_materiales_' . date('Ymd') . '.csv', $data, $headers);
    }
    ...
    if ($tipo === 'solicitudes') {
        ...
        exportarCSV('reporte_solicitudes_' . date('Ymd') . '.csv', $data, $headers);
    }
}
...
<div class="row mb-4">
    <div class="col-12">
        <div class="content-card">
            <h5><i class="bi bi-file-earmark-bar-graph me-2"></i>Generador de Reportes</h5>
            <p class="text-muted mb-0">Exporte datos del sistema en formato CSV/Excel</p>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-4 mb-4">
        <div class="content-card">
            ...
            <div class="d-grid">
                <a href="?exportar=materiales" class="btn btn-primary">
    ...
    <div class="col-md-4 mb-4">
        <div class="content-card">
            ...
            <div class="d-grid">
                <a href="?exportar=solicitudes" class="btn btn-warning">
                    <i class="bi bi-download me-2"></i>Descargar CSV
                </a>
            </div>
        </div>
        ...
        <div class="content-card">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    $mov_stats = $db->query($query)->fetchAll(PDO::FETCH_ASSOC);
                    ?>
                    <ul class="list-group">
                        ...
                        $sol_stat = $db->query($query_sol)->fetch(PDO::FETCH_ASSOC);
                        ?>
                        <li class="list-group-item d-flex justify-content-between">
